    ...
    commands: [
      {
        ...
        title: zh("Previous key binding group"),
        desc: zh("Show the previous which-key group"),
        category: "System",
        run() {
          moveGroup(-1)
        },
      },
      {
        ...
        title: zh("Next key binding group"),
        desc: zh("Show the next which-key group"),
        category: "System",
        run() {
          moveGroup(1)
        },
      },
      {
        ...
        title: zh("Scroll key bindings up"),
        desc: zh("Scroll the which-key panel up"),
        category: "System",
        run() {
          scroll(-columns())
        },
      },
      {
        ...
        title: zh("Scroll key bindings down"),
        desc: zh("Scroll the which-key panel down"),
        category: "System",
        run() {
          scroll(columns())
        },
      ...
      {
        name: command.pageUp,
        title: zh("Page key bindings up"),
        desc: zh("Page the which-key panel up"),
        category: "System",
        run() {
          scroll(-pageSize())
        },
      },
      {
        ...
        title: zh("Page key bindings down"),
        desc: zh("Page the which-key panel down"),
        category: "System",
        run() {
          scroll(pageSize())
        },
      },
      {
        name: command.home,
        title: zh("First item"),
        desc: zh("Jump to the first which-key binding"),
        category: "System",
        run() {
          setOffset(0)
        },
      },
      {
        name: command.end,
        title: zh("Last item"),
        desc: zh("Jump to the last which-key binding"),
        category: "System",
        run() {
          setOffset(maxOffset())
        },
...
const tui: TuiPlugin = async (api) => {
  ...
  api.keymap.registerLayer({
    ...
    commands: [
      {
        name: command.toggle,
        title: zh("Show key bindings"),
        desc: zh("Toggle which-key overlay"),
        category: "System",
        run() {
      ...
      },
      {
        ...
        title: zh("Toggle key bindings layout"),
        desc: zh("Switch which-key between dock and overlay mode"),
        category: "System",
        run() {
          setMode((value) => {
      ...
      },
      {
        ...
        title: zh("Toggle pending key preview"),
        desc: zh("Automatically show which-key for pending key sequences in overlay mode"),
        category: "System",
        run() {
