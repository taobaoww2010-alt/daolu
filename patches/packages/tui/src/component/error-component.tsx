...
export function ErrorComponent(props: { error: Error; reset: () => void; mode?: "dark" | "light" }) {
  ...
  const message = props.error.message || zh("An unknown error occurred.")
  const stack = props.error.stack || zh("No stack trace available.")
  ...
  const actions = [
    { key: "c", label: () => (copied() ? zh("✓ Copied") : zh("Copy report")), copy: true, onUse: copyReport },
    { key: "r", label: () => zh("Restart"), onUse: props.reset },
