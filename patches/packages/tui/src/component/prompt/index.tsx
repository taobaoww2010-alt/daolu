...
export function Prompt(props: PromptProps) {
  ...
  function promptModelWarning() {
    toast.show({
      variant: "warning",
      message: zh("Connect a provider to send prompts"),
      duration: 3000,
    })
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      {
        title: zh("Remove editor context"),
      ...
      {
        title: zh("Warp"),
        desc: zh("Change the workspace for the session"),
        name: "workspace.set",
        category: zh("Session"),
      ...
      {
        title: zh("Move session"),
        desc: zh("Move to another project dir"),
        name: "session.move",
        category: zh("Session"),
        slashName: "move",
        run: () => {
  ...
  useBindings(() => {
    return {
      ...
      bindings: [{ key: "escape", desc: zh("Exit shell mode"), group: zh("Prompt"), cmd: () => setStore("mode", "normal") }],
    }
  })
  ...
  useBindings(() => {
    return {
      ...
      bindings: [{ key: "backspace", desc: zh("Exit shell mode"), group: zh("Prompt"), cmd: () => setStore("mode", "normal") }],
    }
  })
      ...
      commands: [
        {
          ...
          title: zh("Previous prompt history"),
          category: zh("Prompt"),
          run() {
  ...
  async function submitInner() {
    ...
    if (sessionID == null) {
      ...
      if (res.error) {
        ...
        toast.show({
          message: zh("Creating a session failed. Open console for more details."),
          variant: "error",
        })
    ...
    if (store.mode === "shell") {
      ...
      sdk.client.session
        ...
        .catch((error) => {
          toast.show({
            title: zh("Failed to send prompt"),
                  ...
                  {(agent) => (
                    <>
                      <text fg={fadeColor(highlight(), agentMetaAlpha())}>
                        {store.mode === "shell" ? zh("Shell") : Locale.titlecase(agent().name)}
                      </text>
                  ...
                  <box flexDirection="row" gap={1} flexShrink={0}>
                    {(() => {
                      ...
                      const handleMessageClick = () => {
                        ...
                        if (!r) return
                        if (isTruncated()) {
                          void DialogAlert.show(dialog, zh("Retry Error"), r.message)
                        }
                      }
