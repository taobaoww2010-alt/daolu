    ...
    commands: [
      {
        ...
        title: zh("Previous autocomplete item"),
        category: "Autocomplete",
        run: () => menu.move(-1),
      },
      {
        name: "prompt.autocomplete.next",
        title: zh("Next autocomplete item"),
        category: "Autocomplete",
        run: () => menu.move(1),
      },
      {
        name: "prompt.autocomplete.hide",
        title: zh("Hide autocomplete"),
        category: "Autocomplete",
        run: cancelAutocomplete,
      },
      {
        name: "prompt.autocomplete.select",
        title: zh("Select autocomplete item"),
        category: "Autocomplete",
        run() {
      ...
      },
      {
        ...
        title: zh("Complete autocomplete item"),
        category: "Autocomplete",
        run() {
          if (mode() === "slash" && options().length === 0) {
            hide()
